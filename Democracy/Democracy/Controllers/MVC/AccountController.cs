...
namespace Democracy.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterUserView userView)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new User
                {
                    ...
                    Photo = string.IsNullOrEmpty(pic)? null : string.Format("~/Content/Photos/{0}", pic),
                ...
                {
                    db.SaveChanges();
                    var UserASP = this.CreateAPSUser(userView);
        ...
        private ApplicationUser CreateAPSUser(RegisterUserView userView)
        { 
            //user management 
